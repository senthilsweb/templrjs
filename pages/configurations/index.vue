					...
					<div class="flex-1 flex flex-col overflow-y-auto xl:overflow-hidden">
						...
						<div class="flex-1 flex xl:overflow-hidden">
							...
							<div class="flex-1 xl:overflow-y-auto">
								<ConfigurationPageHeader :heading="pageHeading" showbutton="true" guide="Management screen to keep Configuration(s) up-to-date" addClickEvent="evtUpsertConfiguration" />
								<ConfigurationSearch :heading="searchHeading" />
								<div class="w-full">
									<!-- Main content (start)-->

									<!-- Configuration Body content (start)-->
									...
									<!-- Configuration Body content (End)-->
									<!-- Main content (End)-->
								</div>
							</div>
						</div>
...
<script>
	import ConfigurationPageHeader from "@/pages/configurations/ConfigurationPageHeader.vue";
	import ConfigurationSearch from "@/pages/configurations/ConfigurationSearch.vue";
	import ConfigurationGrid from "@/pages/configurations/ConfigurationGrid.vue";
	import ConfigurationUpsert from "@/pages/configurations/ConfigurationUpsert.vue";
