  ...
  <NuxtLayout name="landing">
    <div class="container p-4 lg:p-0 max-w-5xl mx-auto sm:grid grid-cols-12 gap-x-12">
      <div class="col-span-12 lg:col-span-8">
        <TemplrJSSocialCard :title="page.data.title" :description="page.data.description" :tags="page.data.tags" :author="page.data.author" :date="page.data.created_at" color="teal" :type="page.data.type" />
...
const page = ref({});
console.log(`${runtimeConfig.public.API_BASE_URL}/posts?title.eq=${useRoute().params.title}`)
