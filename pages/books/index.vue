          ...
          <div>
              ...
              <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                  <div class="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-8">
                      <p class="text-2xl font-bold tracking-tight text-gray-900">New Arrivals</p>
                      <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6 pl-2 pr-2">
                          <form class="flex flex-1" action="#" method="GET">
                              <input type="text" name="name" id="name"
                                  class="hidden sm:block w-full rounded-md border-0 px-4 py-1.5 ml-44 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                      ...
                      <div class="flex items-center">
                          <button type="button"
                              class="-m-2 ml-5 mr-5 p-2 text-gray-400 hover:text-gray-500 sm:ml-7 lg:hidden">
                          ...
                          <div class="lg:col-span-3">
                              ...
                              <div
                                  ...
                                  <div v-for="article of books[0].body" :key="article._id" class="group relative">
                                      ...
                                      <p class="mt-1 text-sm text-gray-500">{{ $s(article.authors[0]).prune(15)._wrapped
                                      }}</p>
...
const subCategories = [
  { name: 'Bhagavad Gita', href: '#' },
  { name: 'Upanishads', href: '#' },
  { name: 'Itihasas', href: '#' },
  { name: 'Kavyas', href: '#' },
  { name: 'Other Works', href: '#' },
]
const filters = [
  {
      id: 'language',
      name: 'Language',
      options: [
          { value: 'Sanskrit', label: 'Sanskrit', checked: true },
          { value: 'Tamil', label: 'Tamil', checked: false },
          { value: 'Hindi', label: 'Hindi', checked: false },
          { value: 'Kannada', label: 'Kannada', checked: false },
          { value: 'Telegu', label: 'Telegu', checked: false },
          { value: 'Bengali', label: 'Bengali', checked: false },
      ],
  },
  {
      id: 'category',
      name: 'Category',
      options: [
          { value: 'Vedas', label: 'Vedas', checked: false },
          { value: 'Dharma Shastra', label: 'Dharma Shastra', checked: false },
          { value: 'Jataka Tales', label: 'Jataka Tales', checked: false },
          { value: 'Astrology', label: 'Astrology', checked: false },
          { value: 'Puranas', label: 'Puranas', checked: true },
      ],
  },
  {
      id: 'Publishers',
      name: 'Publishers',
      options: [
          { value: 'Gita Press', label: 'Gita Press', checked: false },
          { value: 'Project Madurai', label: 'Project Madurai', checked: false },
          { value: 'Sri Aurobindo Ashram', label: 'Sri Aurobindo Ashram', checked: false },
          { value: 'Sanskrit Documents', label: 'Sanskrit Documents', checked: true },
          { value: 'Kizhakku Pathippagam', label: 'Kizhakku Pathippagam', checked: false },
          { value: 'Noolaham Foundation', label: 'Noolaham Foundation', checked: false },
      ],
  },
]
