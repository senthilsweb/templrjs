    ...
    <div class="relative mx-auto flex max-w-8xl justify-center sm:px-2">
      ...
      <div class="min-w-0 max-w-2xl flex-auto px-4 py-16 lg:max-w-none lg:pr-0 lg:pl-8 xl:px-16">
        <article>
          ...
          <div class="mt-8 text-md text-zinc-600 prose prose-zinc max-w-none dark:prose-invert dark:text-zinc-400 prose-headings:scroll-mt-28 prose-headings:font-display prose-headings:font-normal lg:prose-headings:scroll-mt-[8.5rem] prose-lead:text-zinc-500 dark:prose-lead:text-zinc-400 prose-a:font-semibold dark:prose-a:text-sky-400 prose-a:no-underline dark:prose-pre:ring-1 dark:prose-pre:ring-zinc-300/10 dark:prose-hr:border-zinc-800">
        ...
        <dl class="mt-12 flex border-t border-gray-200 pt-6 dark:border-gray-800">
          ...
          <div class="ml-auto text-right">
            ...
            <dd class="mt-1">
              <a class="text-base font-semibold text-gray-500 hover:text-gray-600 dark:text-gray-400 dark:hover:text-gray-300" :href="next._path">{{ next.title }} <span aria-hidden="true">→</span></a>
            </dd>
          </div>
        </dl>
      </div>
