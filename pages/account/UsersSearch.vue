<template>
    <div>
        <form name="frmSearchUsers" id="frmSearchUsers" ref="frmSearchUsers" v-on:submit.prevent
            class="space-y-8 divide-y divide-gray-200">
            <div v-if="isFilterUsersVisible" class="px-2 pt-2 border-b space-y-2">
                ...
                <div class="py-3 text-right">
                    ...
                    <button @click="searchUsers()" type="submit"
