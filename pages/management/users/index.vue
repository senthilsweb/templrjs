					...
					<div class="flex-1 flex flex-col overflow-y-auto xl:overflow-hidden">
						...
						<div class="flex-1 flex xl:overflow-hidden">
							...
							<div class="flex-1 xl:overflow-y-auto">
								<UserPageHeader :heading="pageHeading" showbutton="true" guide="Manage usership subscriptions i.e. search, add/modify/delete/activate/de-activate userships" addClickEvent="evtUpsertUser" />
