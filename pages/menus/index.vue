					...
					<div class="flex-1 flex flex-col overflow-y-auto xl:overflow-hidden">
						...
						<div class="flex-1 flex xl:overflow-hidden">
							...
							<div class="flex-1 xl:overflow-y-auto">
								<RolePageHeader :heading="pageHeading" showbutton="true" guide="Management screen to keep Role(s) up-to-date" addClickEvent="evtUpsertRole" />
...
<script>
	import RolePageHeader from "@/pages/roles/RolePageHeader.vue";
	import RoleSearch from "@/pages/roles/RoleSearch.vue";
	import RoleGrid from "@/pages/roles/RoleGrid.vue";
	import RoleUpsert from "@/pages/roles/RoleUpsert.vue";
