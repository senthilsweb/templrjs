				...
				<main class="flex-1 flex overflow-hidden">
					<div class="flex-1 flex flex-col overflow-y-auto xl:overflow-hidden">
						...
						<div class="flex-1 flex xl:overflow-hidden">
							...
							<CommonsSecondaryNav title="CRM" api_end_point="/_navigation/crm" />

							<!-- Secondary sidebar (End)-->


							<div class="flex-1 xl:overflow-y-auto">
								<ContactPageHeader :heading="pageHeading" showbutton="true"
									guide="Management screen to keep Contact(s) up-to-date"
									addClickEvent="evtUpsertContact" />
								<ContactSearch :heading="searchHeading" />
								<div class="w-full">
									<!-- Main content (start)-->

									<!-- Contact Body content (start)-->
...
<script>
import ContactPageHeader from "@/pages/contacts/ContactPageHeader.vue";
import ContactSearch from "@/pages/contacts/ContactSearch.vue";
import ContactGrid from "@/pages/contacts/ContactGrid.vue";
import ContactUpsert from "@/pages/contacts/ContactUpsert.vue";
