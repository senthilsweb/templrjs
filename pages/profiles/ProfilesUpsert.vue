...
-->
<template>
  <section v-if="isUpsertProfilesVisible" class="fixed inset-0 overflow-hidden" aria-labelledby="slide-over-title" role="dialog" aria-modal="true">
            ...
            <div class="flex-1 h-0 overflow-y-auto">
              <header class="space-y-1 py-6 px-4 bg-gray-200 bg-opacity-50 sm:px-6">
                <div class="flex items-center justify-between space-x-3">
                  <h2 class="text-lg leading-7 font-medium text-gray-700">Profiles</h2>
                  <div class="h-7 flex items-center">
                    <button v-on:click="isUpsertProfilesVisible = false" aria-label="Close panel" class="rounded-md bg-primary-700 text-primary-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-white">
              ...
              <div v-if="!progress" class="flex-1 flex flex-col justify-between">
                <div class="px-4 divide-y divide-gray-200 sm:px-6">
                  <div class="space-y-6 pt-6 pb-5">
                    <form name="frmProfiles" id="frmProfiles" class="space-y-8 divide-y divide-gray-200" @submit.prevent="upsertProfiles">
                        ...
                        <div class="bg-white space-y-6">
                          <div class="grid grid-cols-1 gap-y-3 gap-x-4 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-6">
                              ...
                              <div class="mt-1">
                                <input type="text" id="username" name="username" v-model="data.username" class="block w-full pl-5 focus:ring-primary-600 focus:border-primary-600 border-gray-300" />
                              </div>
                            </div>                     
                            
                            <div class="sm:col-span-6">
                              <label for="full_name" class="block text-sm font-medium text-gray-700">Full_name</label>
                              <div class="mt-1">
                                <input type="text" id="full_name" name="full_name" v-model="data.full_name" class="block w-full pl-5 focus:ring-primary-600 focus:border-primary-600 border-gray-300" />
                              </div>
                            </div>                     
                            
                            <div class="sm:col-span-6">
                              <label for="avatar_url" class="block text-sm font-medium text-gray-700">Avatar_url</label>
                              <div class="mt-1">
                                <input type="text" id="avatar_url" name="avatar_url" v-model="data.avatar_url" class="block w-full pl-5 focus:ring-primary-600 focus:border-primary-600 border-gray-300" />
                              </div>
                            </div>                     
                            ...
                            <div class="sm:col-span-6">
                              ...
                              <div class="mt-1">
                                <input type="text" id="website" name="website" v-model="data.website" class="block w-full pl-5 focus:ring-primary-600 focus:border-primary-600 border-gray-300" />
                              </div>
                            </div>                     
                            ...
                            <div class="sm:col-span-6">
                              <label for="is_sso_user" class="block text-sm font-medium text-gray-700">Is_sso_user</label>
                              <div class="mt-1">
                                <input type="text" id="is_sso_user" name="is_sso_user" v-model="data.is_sso_user" class="block w-full pl-5 focus:ring-primary-600 focus:border-primary-600 border-gray-300" />
                              </div>
                            </div>                     
                            
                            <div class="sm:col-span-6">
                              <label for="f_name" class="block text-sm font-medium text-gray-700">F_name</label>
                              <div class="mt-1">
                                <input type="text" id="f_name" name="f_name" v-model="data.f_name" class="block w-full pl-5 focus:ring-primary-600 focus:border-primary-600 border-gray-300" />
                              </div>
                            </div>                     
                            
                            <div class="sm:col-span-6">
                              <label for="l_name" class="block text-sm font-medium text-gray-700">L_name</label>
                              <div class="mt-1">
                                <input type="text" id="l_name" name="l_name" v-model="data.l_name" class="block w-full pl-5 focus:ring-primary-600 focus:border-primary-600 border-gray-300" />
                              </div>
                            </div>                     
...
useNuxtApp().$bus.$on('evtDeleteProfiles', (data) => {
  deleteProfiles(data._cells[0].data);
});
