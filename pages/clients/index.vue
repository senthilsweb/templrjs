					...
					<div class="flex-1 flex flex-col overflow-y-auto xl:overflow-hidden">
						...
						<div class="flex-1 flex xl:overflow-hidden">
							...
							<div class="flex-1 xl:overflow-y-auto">
								<ClientPageHeader :heading="pageHeading" showbutton="true"
									guide="Management screen to keep Client(s) up-to-date"
									addClickEvent="evtUpsertClient" />
								<ClientSearch :heading="searchHeading" />
								<div class="w-full">
									<!-- Main content (start)-->
...
<script>
import ClientPageHeader from "@/pages/clients/ClientPageHeader.vue";
import ClientSearch from "@/pages/clients/ClientSearch.vue";
import ClientGrid from "@/pages/clients/ClientGrid.vue";
import ClientUpsert from "@/pages/clients/ClientUpsert.vue";
