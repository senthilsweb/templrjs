          ...
          <div class="flex-1 flex flex-col overflow-y-auto xl:overflow-hidden">
            ...
            <div class="flex-1 flex xl:overflow-hidden">
              ...
              <div class="flex-1 xl:overflow-y-auto">
                <UsersPageHeader heading="Users" showbutton="true" guide="Management screen to keep Users(s) up-to-date" searchClickEvent="evtToggleSearchUsersForm" addClickEvent="evtUserSignup" />
                <UsersSearch heading="Filter Users" />
                <div class="w-full">
                  <!-- Main content (start)-->
                  <!-- Users Body content (start)-->
                  <div class="space-y-8 divide-y divide-gray sm:space-y-5 pt-5">
                    <div>
                      <UsersGrid />
                    </div>
                  </div>
                  <!-- Users Body content (End)-->
                  <!-- Main content (End)-->
                </div>
              </div>
            </div>
...
//-----------------------------------------------------------------------------------------------------
import UsersPageHeader from '@/pages/organization/users/UsersPageHeader.vue';
import UsersSearch from '@/pages/organization/users/UsersSearch.vue';
import UsersGrid from '@/pages/organization/users/UsersGrid.vue';
import UsersUpsert from '@/pages/organization/users/UsersUpsert.vue';
import UserSignup from '@/pages/organization/users/UserSignup.vue';
