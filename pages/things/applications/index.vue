        ...
        <main class="flex-1 flex overflow-hidden">
          <div class="flex-1 flex flex-col overflow-y-auto xl:overflow-hidden">
            ...
            <div class="flex-1 flex xl:overflow-hidden">
              ...
              <CommonsSecondaryNav title="IoT/Things" api_end_point="/_navigation/things" />

              <!-- Secondary sidebar (End)-->

              <div class="flex-1 xl:overflow-y-auto">
                <ApplicationPageHeader heading="Application" showbutton="true" guide="Management screen to keep Application(s) up-to-date" searchClickEvent="evtSearchApplications" addClickEvent="evtUpsertApplications" />
                <ApplicationSearch heading="Filter Application" />
                <div class="w-full">
                  <!-- Main content (start)-->

                  <!-- Application Body content (start)-->
...
//-----------------------------------------------------------------------------------------------------
import ApplicationPageHeader from '@/pages/things/applications/ApplicationPageHeader.vue';
import ApplicationSearch from '@/pages/things/applications/ApplicationSearch.vue';
import ApplicationGrid from '@/pages/things/applications/ApplicationGrid.vue';
import ApplicationUpsert from '@/pages/things/applications/ApplicationUpsert.vue';
