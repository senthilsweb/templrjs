...
import InquiriesPageHeader from './InquiriesPageHeader-81426abb.mjs';
import _sfc_main$1 from './InquiriesSearch-99f2c9ea.mjs';
import _sfc_main$2 from './InquiriesGrid-e5911e7d.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(InquiriesPageHeader, {
        showbutton: "true",
        heading: "",
        guide: "Management screen to keep Inquiries(s) up-to-date",
        addClickEvent: "evtUpsertInquiries"
      }, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/inquiries/index.vue");
