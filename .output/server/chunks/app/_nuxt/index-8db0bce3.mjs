...
import UserPageHeader from './UserPageHeader-2e564de0.mjs';
import UserSearch from './UserSearch-5b075a08.mjs';
import _sfc_main$1 from './UserGrid-f8c06f7b.mjs';
import UserUpsert from './UserUpsert-c89cca9e.mjs';
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(UserPageHeader, {
      ...
      _push(ssrRenderComponent(UserSearch, { heading: _ctx.searchHeading }, null, _parent));
      ...
      _push(ssrRenderComponent(UserUpsert, null, null, _parent));
      _push(`</div>`);
    };
  }
});
