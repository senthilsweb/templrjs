...
import _sfc_main$1 from './ApplicationPageHeader-1ceaf9e5.mjs';
import _sfc_main$2 from './ApplicationSearch-cbb51707.mjs';
import _sfc_main$3 from './ApplicationGrid-2bd4b59f.mjs';
import _sfc_main$4 from './ApplicationUpsert-a62d7a88.mjs';
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, {
        heading: "Application",
        showbutton: "true",
        guide: "Management screen to keep Application(s) up-to-date",
        searchClickEvent: "evtSearchApplications",
        addClickEvent: "evtUpsertApplications"
      }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$2, { heading: "Filter Application" }, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/things/applications/index.vue");
