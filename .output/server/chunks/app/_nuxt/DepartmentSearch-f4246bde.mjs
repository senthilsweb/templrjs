...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><form name="frmSearchDepartment" id="frmSearchDepartment" class="space-y-8 divide-y divide-gray-200">`);
      if (_ctx.isShowSearchDepartmentVisible) {
        ...
        _push(ssrRenderComponent(Dropdownlist, {
          ...
          onChange: _ctx.handleSelectedInDepartmentLimit,
          show_label: "true",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/departments/DepartmentSearch.vue");
