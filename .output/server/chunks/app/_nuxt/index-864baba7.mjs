...
import TypePageHeader from './TypePageHeader-cdc7ec76.mjs';
import _sfc_main$1 from './TypeSearch-8d248e50.mjs';
import _sfc_main$2 from './TypeGrid-cd437946.mjs';
import _sfc_main$3 from './TypeUpsert-ab82eac9.mjs';
...
const __default__ = {
  ...
  components: {
    TypePageHeader,
    TypeSearch: _sfc_main$1,
    TypeGrid: _sfc_main$2,
    TypeUpsert: _sfc_main$3
  },
  data() {
    return {
      user: {},
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(TypePageHeader, {
        heading: _ctx.pageHeading,
        showbutton: "true",
        guide: "Management screen to keep Type(s) up-to-date",
        addClickEvent: "evtUpsertType"
      }, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/configurations/types/index.vue");
