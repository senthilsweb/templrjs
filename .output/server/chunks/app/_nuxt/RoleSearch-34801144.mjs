...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><form name="frmSearchRole" id="frmSearchRole" class="space-y-8 divide-y divide-gray-200">`);
      if (_ctx.isShowSearchRoleVisible) {
        ...
        _push(ssrRenderComponent(Dropdownlist, {
          ...
          onChange: _ctx.handleSelectedInRoleLimit,
          show_label: "true",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/menus/RoleSearch.vue");
