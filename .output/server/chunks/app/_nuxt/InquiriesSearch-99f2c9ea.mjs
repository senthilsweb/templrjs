  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => useAsyncData(
      ...
      () => $fetch("/api/generic", {
        initialCache: false,
        method: "post",
        body: { collection: "inquiries", projection: {}, filter: { property_type: { $eq: "limit" } }, limit: 1e4 },
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><form name="frmSearchInquiries" id="frmSearchInquiries" class="space-y-8 divide-y divide-gray-200">`);
      if (_ctx.isShowSearchInquiriesVisible) {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/inquiries/InquiriesSearch.vue");
