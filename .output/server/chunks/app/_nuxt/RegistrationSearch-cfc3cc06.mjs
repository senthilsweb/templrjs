...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  async setup(__props) {
    ...
    const { data: nav_parents } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "registrations-list-" + Math.random,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><form name="frmSearchRegistration" id="frmSearchRegistration" class="space-y-8 divide-y divide-gray-200">`);
      if (_ctx.isShowSearchRegistrationVisible) {
        ...
        _push(ssrRenderComponent(Dropdownlist, {
          ...
          onChange: handleSelectedInRegistration_Parent,
          show_label: "true",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/registration/RegistrationSearch.vue");
