...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if ($data.pgShowbutton == "true") {
    _push(`<div class="ml-2 mt-2 pr-6 flex items-center space-x-4 sm:ml-6 sm:space-x-6"><button type="button" class="zyn-button">Edit</button></div>`);
  } else {
    _push(`<!---->`);
  }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/organization/OrganizationPageHeader.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const OrganizationPageHeader = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { OrganizationPageHeader as default };
