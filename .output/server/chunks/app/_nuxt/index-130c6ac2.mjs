...
import DepartmentPageHeader from './DepartmentPageHeader-d4f81d1d.mjs';
import _sfc_main$1 from './DepartmentSearch-f4246bde.mjs';
import _sfc_main$2 from './DepartmentGrid-cc357ffe.mjs';
import _sfc_main$3 from './DepartmentUpsert-ad08cd17.mjs';
...
const __default__ = {
  ...
  components: {
    ...
    DepartmentSearch: _sfc_main$1,
    DepartmentGrid: _sfc_main$2,
    DepartmentUpsert: _sfc_main$3
  },
  data() {
    return {
      user: {},
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(DepartmentPageHeader, {
