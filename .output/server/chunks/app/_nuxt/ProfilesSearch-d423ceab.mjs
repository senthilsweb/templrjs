...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><form name="frmSearchProfiles" id="frmSearchProfiles" class="space-y-8 divide-y divide-gray-200">`);
      if (unref(isShowSearchProfilesVisible)) {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/profiles/ProfilesSearch.vue");
