...
import ContactPageHeader from './ContactPageHeader-802c1c30.mjs';
import _sfc_main$1 from './ContactSearch-6ae9eb9a.mjs';
import _sfc_main$2 from './ContactGrid-aa32664f.mjs';
import _sfc_main$3 from './ContactUpsert-f947f43f.mjs';
...
const __default__ = {
  ...
  components: {
    ContactPageHeader,
    ContactSearch: _sfc_main$1,
    ContactGrid: _sfc_main$2,
    ContactUpsert: _sfc_main$3
  },
  data() {
    return {
      user: {},
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(ContactPageHeader, {
