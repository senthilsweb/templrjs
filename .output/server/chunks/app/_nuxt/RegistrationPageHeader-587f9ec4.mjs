...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if ($data.pgShowbutton == "true") {
    ...
    _push(` Add a Registration </button></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div></header>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/registration/RegistrationPageHeader.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const RegistrationPageHeader = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { RegistrationPageHeader as default };
