...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  __name: "ConfigurationGrid",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    const api = "/api/configurations/";
    useState("grid");
    ...
    [__temp, __restore] = withAsyncContext(() => useAsyncData(
      "Configurations-list-" + Math.random,
      () => $fetch(api, {
        initialCache: false,
        method: "post",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/configurations/ConfigurationGrid.vue");
