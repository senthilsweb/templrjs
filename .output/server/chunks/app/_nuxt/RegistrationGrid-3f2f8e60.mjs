...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    useNuxtApp().$bus.$on("evtSearchRegistration", (data2) => {
      searchRegistrations(data2);
    });
    ref();
    const { data: Registrations } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/registration/RegistrationGrid.vue");
