  ...
  methods: {
    async upsertBilling(args) {
      try {
        ...
        useNuxtApp().$bus.$on("evtRefreshBillingDatatable");
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/account/BillingPlansUpsert.vue");
