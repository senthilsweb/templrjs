...
import RolePageHeader from './RolePageHeader-c86be62d.mjs';
import _sfc_main$1 from './RoleSearch-c9de2dab.mjs';
import _sfc_main$2 from './RoleGrid-33f9dc05.mjs';
import _sfc_main$3 from './RoleUpsert-b5809fea.mjs';
...
const __default__ = {
  ...
  components: {
    RolePageHeader,
    RoleSearch: _sfc_main$1,
    RoleGrid: _sfc_main$2,
    RoleUpsert: _sfc_main$3
  },
  data() {
    return {
      user: {},
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(RolePageHeader, {
        ...
        showbutton: "true",
        guide: "Management screen to keep Role(s) up-to-date",
