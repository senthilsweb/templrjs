    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (_ctx.isUpsertClientVisible) {
        ...
        if (!_ctx.progress) {
          ...
          _push(`</div><div class="sm:col-span-6"><h2 class="font-bold text-yellow-700">Record Information</h2></div><div class="sm:col-span-6">`);
          _push(ssrRenderComponent(_component_Dropdownlist, {
            data: { data: unref(record_status).documents },
            onChange: _ctx.handleSelectedInClient_record_status,
            show_label: "true",
          ...
          _push(ssrRenderComponent(_component_Dropdownlist, {
            ...
            onChange: _ctx.handleSelectedInClient_mark_as_delete,
            show_label: "true",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/clients/ClientUpsert.vue");
