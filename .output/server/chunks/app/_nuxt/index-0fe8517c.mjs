...
import EmployeePageHeader from './EmployeePageHeader-6a894029.mjs';
import _sfc_main$1 from './EmployeeSearch-0723a993.mjs';
import _sfc_main$2 from './EmployeeGrid-6104c5f1.mjs';
import _sfc_main$3 from './EmployeeUpsert-e53f2620.mjs';
import _sfc_main$4 from './ClientAllocationUpsert-fcb5b4c4.mjs';
...
const __default__ = {
  ...
  components: {
    EmployeePageHeader,
    EmployeeSearch: _sfc_main$1,
    EmployeeDataTable: _sfc_main$2,
    ClientAllocationUpsert: _sfc_main$4,
    EmployeeUpsert: _sfc_main$3
  },
  data() {
    return {
      user: {},
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(EmployeePageHeader, {
