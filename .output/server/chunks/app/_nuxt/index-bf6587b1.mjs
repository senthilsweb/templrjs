...
import ConfigurationPageHeader from './ConfigurationPageHeader-ef649b14.mjs';
import _sfc_main$1 from './ConfigurationSearch-3930228e.mjs';
import _sfc_main$2 from './ConfigurationGrid-981b9791.mjs';
import _sfc_main$3 from './ConfigurationUpsert-052a511b.mjs';
...
const __default__ = {
  ...
  components: {
    ...
    ConfigurationSearch: _sfc_main$1,
    ConfigurationGrid: _sfc_main$2,
    ConfigurationUpsert: _sfc_main$3
  },
  data() {
    return {
      user: {},
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(ConfigurationPageHeader, {
        heading: _ctx.pageHeading,
        showbutton: "true",
        guide: "Management screen to keep Configuration(s) up-to-date",
        addClickEvent: "evtUpsertConfiguration"
      }, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/configurations/index.vue");
