...
import RegistrationPageHeader from './RegistrationPageHeader-587f9ec4.mjs';
import _sfc_main$1 from './RegistrationSearch-cfc3cc06.mjs';
import _sfc_main$3 from './RegistrationUpsert-23d07428.mjs';
import _sfc_main$2 from './RegistrationGrid-3f2f8e60.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(RegistrationPageHeader, {
        showbutton: "false",
        heading: "Membership registrations",
        guide: "Management screen to keep new membership registration(s) up-to-date",
        addClickEvent: "evtUpsertRegistration"
      }, null, _parent));
