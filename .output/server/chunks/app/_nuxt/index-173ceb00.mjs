...
import BillingDisplay from './BillingDisplay-dad74023.mjs';
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></div><div class="flex flex-col min-w-0 flex-1 overflow-hidden"><div class="flex-1 relative z-0 flex overflow-hidden"><main class="flex-1 flex overflow-hidden"><div class="flex-1 flex flex-col overflow-y-auto xl:overflow-hidden"><nav aria-label="Breadcrumb" class="bg-white border-b border-blue-gray-200 xl:hidden"><div class="max-w-3xl mx-auto py-3 px-4 flex items-start sm:px-6 lg:px-8"><a href="#" class="-ml-1 inline-flex items-center space-x-3 text-sm font-medium text-blue-gray-900"><svg class="h-5 w-5 text-blue-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg><span>Billing</span></a></div></nav><div class="flex-1 flex xl:overflow-hidden"><div class="flex-1 xl:overflow-y-auto"><div class="max-w-5xl mx-4"><div class="space-y-8 divide-y divide-gray sm:space-y-5 pt-5"><div><h3 class="text-lg leading-6 font-medium text-gray-900">Personal Billing</h3><p class="mt-1 max-w-2xl text-sm text-gray-500"></p></div></div><div class="space-y-8 divide-y divide-gray sm:space-y-5 pt-5"><div><h3 class="text-lg leading-6 font-medium text-gray-900">Billing &amp; plans / Payment information</h3><p class="mt-1 max-w-2xl text-sm text-gray-500"></p></div><div></div></div>`);
      _push(ssrRenderComponent(BillingDisplay, { class: "w-2/4" }, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/management/billing/index.vue");
