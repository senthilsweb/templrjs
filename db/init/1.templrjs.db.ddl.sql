...
CREATE TABLE navigation (code CHARACTER VARYING, parent_code CHARACTER VARYING, name CHARACTER VARYING NOT NULL, description CHARACTER VARYING, icon CHARACTER VARYING, href CHARACTER VARYING, iconforeground TEXT, iconbackground TEXT, click_event TEXT, tenant_code TEXT, is_active BOOLEAN DEFAULT true, is_action_button BOOLEAN DEFAULT false, nav_module_code TEXT, sort_order SMALLINT, is_footer_description BOOLEAN DEFAULT false, css_class TEXT, id INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY, PRIMARY KEY (id), CONSTRAINT uc_navigation_code_parent_code UNIQUE (code, parent_code));
  CREATE TABLE properties (code CHARACTER VARYING DEFAULT ''::character varying NOT NULL, name CHARACTER VARYING NOT NULL, parent_code CHARACTER VARYING, description CHARACTER VARYING, additional_attributes JSONB, tenant CHARACTER VARYING, update_count BIGINT, created_by CHARACTER VARYING, updated_by CHARACTER VARYING, created_at TIMESTAMP(6) WITH TIME ZONE DEFAULT now(), updated_at TIMESTAMP(6) WITH TIME ZONE DEFAULT now(), is_active BOOLEAN DEFAULT true, is_archived BOOLEAN DEFAULT false, id SERIAL NOT NULL, PRIMARY KEY (id), CONSTRAINT uc__properties__code__parent_code UNIQUE (code, parent_code));
